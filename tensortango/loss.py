"""Loss function is the same as an error function and is nothing more than the 
difference between where I am now and where I want to be """
...
class Loss():
    def loss(self, predictions: tensor.Tensor, labels: tensor.Tensor) -> float:
        """The value of the loss function is the difference of predictions and the known labels.
    ...
    def grad(self, predictions: tensor.Tensor, labels: tensor.Tensor) -> tensor.Tensor:
        """The gradient of the loss function with respect to the predictions
...
class MSE(Loss):
    ...
    # grad is the derivative of loss 
    def grad(self, predictions: tensor.Tensor, labels: tensor.Tensor) -> tensor.Tensor:
